...
```powershell
node x-skills/scripts/cli.mjs <command>
```
...
npm run x:login
node x-skills/scripts/cli.mjs publish --text "Hello from pipeline!" --image "D:/test/hermes/图片/X/cover.jpg"
node x-skills/scripts/cli.mjs publish --file "D:/test/hermes/文章/X/post.md"
```
